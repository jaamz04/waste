...
exports.getPosts = async (req, res)=>{
    ...
    // how many post send to the user
...
exports.singlePost = async (req, res)=>{
    ...
    try {
        ...
        if(!existingPost){
            res.status(404).json({success:true, message:"Post Unavailable"});
        }
...
exports.updatePost = async(req,res)=>{
    ...
    try {
        ...
        res.status(201).json({success:true, message:"Updated", data: result});
    } catch (error) {
        console.log(error);
    }
}
...
exports.deletePost = async(req,res)=>{
    ...
    try {
        ...
        if(!existingPost){
            res.status(404).json({success:true, message:"Post already Unavailable"});
        }
